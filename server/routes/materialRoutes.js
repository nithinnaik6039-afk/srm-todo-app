...
import { getMaterials, uploadMaterial, deleteMaterial, trackDownload } from '../controllers/materialController.js';
...
router.patch('/:id/download', trackDownload);                                              // Track download
